...
<div class="mx-auto h-full p-4 flex flex-col items-center justify-center">
	...
	<form class="w-full max-w-lg" on:submit|preventDefault={sendEmail}>
		<div class="flex flex-wrap -mx-3 mb-6">
			<div class="w-full px-3 mb-6 md:mb-0">
				...
				<input
					class="block w-full bg-neutral-content border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
					id="grid-name"
					type="text"
			...
			<div class="w-full px-3 mb-6">
				<label class="block uppercase tracking-wide text-xs font-bold mb-2" for="grid-subject">
					Subject
				</label>
				<input
					class="block w-full bg-neutral-content  border rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
					id="grid-subject"
					type="text"
			...
			<div class="w-full px-3 mb-6">
				...
				<textarea
					class="block w-full bg-neutral-content border rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500"
					id="grid-message"
			...
			<div class="w-full flex items-center justify-between px-3">
				<button
					class="shadow bg-info font-bold py-2 px-4 rounded"
					type="submit"
				>
					Send
				</button>
